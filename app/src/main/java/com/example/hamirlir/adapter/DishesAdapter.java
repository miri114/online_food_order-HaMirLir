...
public class DishesAdapter extends RecyclerView.Adapter<DishesAdapter.MyViewHolder> {
    ...
    public DishesAdapter(Context context, ArrayList<Dishes> dishesArrayList) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            dish_name = (TextView) itemView.findViewById(R.id.txtDish);
            dish_image = (ImageView) itemView.findViewById(R.id.dishImage);
        }
    }
